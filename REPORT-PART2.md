...
*NB: Nécessité de se connecter une premiere fois pour récupérer le token.
...
![K6-Start-light-test.png](screens/Part-2-Tests/K6-Start-light-test.png)

![K6-light-test-result.png](screens/Part-2-Tests/K6-light-test-result.png)

![Grafana-light-test-response.png](screens/Part-2-Tests/Grafana-light-test-response.png)
...
Sur mon pauvre MAC de 10ans, à partir de 50 VUs je suis déjà KO avec 69% de réussite sur les task responses (en dessous de 500ms pour répondre) et 99% de réussite pour les responses-notifs (moins de 500ms).
...
![K6-realistic-test.png](screens/Part-2-Tests/K6-realistic-test.png)

![Grafana_realistic_Business.png](screens/Part-2-Tests/Grafana_realistic_Business.png)

![Grafana_realistic_test.png](screens/Part-2-Tests/Grafana_realistic_test.png)`
...
![k6-realistic-test-with-scale.png](screens/Part-2-Tests/k6-realistic-test-with-scale.png)
